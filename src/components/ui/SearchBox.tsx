  ...
  return (
    <div className="flex flex-col justify-center items-center w-full max-w-3xl p-3 gap-2 ">
      <div className="flex items-center w-full gap-2">
        <div className="flex items-center w-full bg-[#E2E4E9] px-3 py-2.5 rounded-full">
          <Search
            color="#02834E"
            width={20}
            height={20}
          ...
          <input
            type="text"
            placeholder="Search"
            className="bg-transparent border-none outline-none text-neutral-600 font-medium ml-3 w-full text-sm"
          />
        </div>
